...
var dbUrl = "mongodb://to-do-list:YldsAtQ01N7YxlgzUhzMuOYpog62AX0BiqaUM1ZE93a6T86X4kF20IsqvnLArzeDfJtvi4orKoIJRAxHg1IQ2A==@to-do-list.documents.azure.com:10255/todolistDB?ssl=true&replicaSet=globaldb";
...
function getToDoListByName (listName, callback) {
  getToDoLists(function (error, data) {
    ...
    var result = Array.prototype.find.call(data, x => x.name == listName);
